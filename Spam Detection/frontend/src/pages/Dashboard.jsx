...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    getMetrics()
      ...
      .catch(e => {
        const msg = e?.response?.data?.detail || 'Failed to load metrics'
  ...
  return (
    <div className="container">
      ...
      <div className="grid grid-4" style={{ marginTop: 12 }}>
        ...
        <KPIStat
          title="Spam Detected"
          value={t.spam.toLocaleString()}
          subtitle={((t.spam / (t.scans || 1)) * 100).toFixed(1) + '% spam rate'}
          color="#ef4444"
        />
        <KPIStat
          title="Safe Emails"
          value={t.ham.toLocaleString()}
          subtitle={((t.ham / (t.scans || 1)) * 100).toFixed(1) + '% safe rate'}
          color="#22c55e"
        />
        <KPIStat
